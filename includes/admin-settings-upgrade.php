<div id="fl-upgrade-form" class="fl-settings-form fl-upgrade-page-content">
	...
	<p><?php _e('Along with access to our expert support team, the premium versions of Tesseract Plus Plugin are packed with more features to save you time and make building websites easier!', 'fl-builder'); ?></p>
	...
	<p><?php _e('Come by the Tesseract Plus Plugin Homepage to learn more about what our premium features can do for you!', 'fl-builder'); ?></p>
