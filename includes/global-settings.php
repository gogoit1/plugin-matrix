				...
				'css'  			=> array(
					...
					'fields'        => array(
						'css' 			=> array(
							...
							'default'		=> '.fl-page-header-primary,.fl-page-bar{position:relative;z-index:3;background:none;} .fl-page .fl-page-header-primary .fl-page-header-wrap {border-bottom: none;}.fl-page-header-primary .fl-page-nav-wrap {background: none;border-top:none;border-bottom:none;}@media(max-width:767px){.fl-page-header-primary{position:fixed !important;width:100% !important;}}'
