<div class="wrap">
	...
	<p class="fl-license-error" style="padding:10px 20px; background: #d54e21; color: #fff;">
		...
		&nbsp;<a style="color: #fff;" href="https://www.tesseracttheme.com" target="_blank"><?php _e('Visit Account', 'fl-builder'); ?> &raquo;</a>
	</p>
	<?php endif; ?>
	...
	<p>
		<?php echo sprintf( __( 'Enter your <a%s>license key</a> to enable remote updates and support.', 'fl-builder' ), ' href="https://www.tesseracttheme.com/" target="_blank"' ) ?>
	</p>
