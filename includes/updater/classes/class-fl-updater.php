...
/**
 * Manages remote updates for all Tesseract Plus Plugin products.
 *
 * @since 1.0
 */
final class FLUpdater {
	...
	/**
	 * The API URL for the Tesseract Plus Plugin update server. 
	 *
	 * @since 1.0
	 * @access private
	 * @var string $_updates_api_url
	 */
	static private $_updates_api_url = 'http://www.tesseracttheme.com/';
