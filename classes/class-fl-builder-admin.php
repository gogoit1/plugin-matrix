...
final class FLBuilderAdmin {
	...
	static public function activate()
	{
		...
		if ( $activate ) {
			...
			update_site_option('_fl_builder_knowledge_base_url','http://tesseracttheme.com/knowledge-base/');		
			update_site_option('_fl_builder_forums_url','http://tesseracttheme.com/feedback/');		
