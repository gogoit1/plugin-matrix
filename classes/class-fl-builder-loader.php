...
if ( ! class_exists( 'FLBuilderLoader' ) ) {
	...
	final class FLBuilderLoader {
		...
		static public function init()
		{
			...
			$lite_dirname   = 'tesseractplus-plugin';
		...
		static private function define_constants()
		{
			...
			define('FL_BUILDER_SUPPORT_URL', 'http://www.tesseractplus.com/');
			define('FL_BUILDER_UPGRADE_URL', 'http://www.tesseractplus.com/');
			define('FL_BUILDER_DEMO_URL', 'http://www.tesseractplus.com');
			define('FL_BUILDER_OLD_DEMO_URL', 'http://www.tesseractplus.com');
			define('FL_BUILDER_DEMO_CACHE_URL', 'http://www.tesseractplus.com/wp-content/uploads/tesseractplus-plugin/cache/');
		}
		...
		static private function load_files()
		{
			...
			require_once FL_BUILDER_DIR . 'addons/index.php';
		}
		...
		static public function admin_notice()
		{
			...
			$message = __( 'You currently have two versions of Tesseract Plus Plugin active on this site. Please <a href="%s">deactivate one</a> before continuing.', 'fl-builder' );
