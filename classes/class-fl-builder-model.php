...
final class FLBuilderModel {
	...
	static public function register_module($class, $form)
	{
		if(class_exists($class)) {
			...
			if ( isset( self::$modules[ $instance->slug ] ) ) {
				error_log( sprintf( _x( 'A module with the filename %s.php already exists! Please namespace your module filenames to ensure compatibility with Tesseract Plus Plugin.', '%s stands for the module filename', 'fl-builder' ), $instance->slug ) );
				return;
			}
	...
	static public function get_branding_icon()
	{
		...
		return FL_BUILDER_URL . 'img/tesseractplus.png';
	}
	...
	static public function get_help_button_defaults()
	{
		$defaults = array(
			...
			'tour'					=> true,
			'video'					=> false,
			'video_embed'			=> 'http://tesseracttheme.com/knowledge-base/',
			'knowledge_base'		=> true,
			'knowledge_base_url'	=> 'http://tesseracttheme.com/knowledge-base/',
			'forums'				=> true,
			'forums_url'			=> 'http://tesseracttheme.com/feedback/',
		);
	...
	/**
	 * Returns the plugin basename for Tesseract Plus Plugin.
	 *
	 * @since 1.0
	 * @return string
	 */
